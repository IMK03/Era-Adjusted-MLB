...
comparison_data <- comparison_data %>%
  rename(
    Park_Factor_Bat = Park_Factor_Batting_One,
    Park_Factor_Pitch = Park_Factor_Pitching_One
  )

# Select and display the table
comparison_data <- comparison_data %>%
  select(Team, Wins, Losses, Pythagorean_Wins, Pythagorean_Losses, Runs_Scored, Runs_Allowed, Run_differential, Park_Factor_Bat, Park_Factor_Pitch)
...
mlb_average_bat <- mlb_average_bat %>%
  select(Year, PA, AB, H, X1B, X2B, X3B, HR, RBI, BB, SO, BA, OBP, SLG, OPS, TB, SH, SF, BIP, SB)
kable(mlb_average_bat, caption = "Batting Statistics Comparison 2005 and 2016 MLB seasons") %>%
  kable_styling("striped", full_width = F)
mlb_average_pitch <- mlb_average_pitch %>%
  select(Year, R.G, CG, SHO, R, ER, ERA, HR, IBB, SV, H9, HR9, BB9, SO9, SO.W, BAbip, WHIP, BF, BK, WP)
...
kable(league_totals_t_test_05, caption = "T-Test Results: 2005 vs 21st Century MLB Seasons")
...
kable(league_totals_t_test_16, caption = "T-Test Results: 2016 vs 21st Century MLB Seasons")
...
team_pitch <- team_pitch %>%
  select(Tm, 'RA/G', 'W-L%', ERA, CG, tSho, SV, IP, H9, HR, BB9, SO9, LOB, WHIP, FIP, 'ERA+', BF, WP, R, ER)
...
batting_stats <- c("BA", "OBP", "SLG", "OPS", "OPS+", "H", "HR", "R", "RBI", "SB")  
pitching_stats <- c("ERA", "ERA+", "ER", "WHIP", "FIP", "SO9", "H9", "HR9", "BB9") 
...
white_sox_batters <- batting_summary %>% filter(Team == "Sox 2005") %>%
   rename(position = Pos) %>%  # Rename "Pos" to "position"
  select(name, position, PA, efWAR, ebWAR, fWAR, bWAR)
...
white_sox_starting <- starting_pitchers %>% filter(Team == "Sox 2005") %>%
   rename(position = Pos) %>%  # Rename "Pos" to "position"
  select(name, position, IP, efWAR, ebWAR, fWAR, bWAR)
...
white_sox_bullpen <- bullpen_pitchers %>% filter(Team == "Sox 2005") %>%
     rename(position = Pos) %>%  # Rename "Pos" to "position"
  mutate(position = replace_na(position, "RP")) %>%  # Replace NA with "RP"
  select(name, position, IP, efWAR, ebWAR, fWAR, bWAR)
...
```{r charts, echo=FALSE, message=FALSE, warning=FALSE, fig.align="center"}
...
ggplot(batting_summary, aes(x = ebWAR, y = efWAR, image = logo, label = name, size = PA)) +
  geom_image(size = 0.155) +  # Adjust logo size
  geom_text_repel(vjust = -0.5, show.legend = FALSE) +
  labs(title = "efWAR vs ebWAR: 2005 White Sox vs. 2016 Cubs - Batters",
       x = "ebWAR", y = "efWAR") +
  theme_minimal() +
...
```
```{r chartss, echo = FALSE, warning=FALSE, message=FALSE, fig.align="center"}
# Plot 2: bWAR vs fWAR
ggplot(batting_summary, aes(x = bWAR, y = fWAR, image = logo, label = name, size = PA)) +
  geom_image(size = 0.15) +
  geom_text_repel(vjust = -0.5, show.legend = FALSE) +
  labs(title = "fWAR vs bWAR: 2005 White Sox vs. 2016 Cubs - Batters",
       x = "bWAR", y = "fWAR") +
  theme_minimal() +
...
```
```{r chartsss, echo = FALSE, warning=FALSE, message=FALSE, fig.align="center"}

# Plot 3: bWAR vs ebWAR
ggplot(batting_summary, aes(x = bWAR, y = ebWAR, image = logo, label = name, size = PA)) +
  geom_image(size = 0.15) +
  geom_text_repel(vjust = -0.5, show.legend = FALSE) +
  labs(title = "ebWAR vs bbWAR: 2005 White Sox vs. 2016 Cubs - Batters",
       x = "bWAR", y = "ebWAR") +
  theme_minimal() +
  scale_x_continuous(breaks = seq(floor(min(batting_summary$bWAR, na.rm = TRUE)), ceiling(max(batting_summary$bWAR, na.rm = TRUE)), by = 1)) +
...
```
```{r chartssss, echo = FALSE, warning=FALSE, message=FALSE, fig.align="center"}

# Plot 4: fWAR vs efWAR
ggplot(batting_summary, aes(x = fWAR, y = efWAR, image = logo, label = name, size = PA)) +
  geom_image(size = 0.15) +
  geom_text_repel(vjust = -0.5, show.legend = FALSE) +
  labs(title = "efWAR vs fWAR: 2005 White Sox vs. 2016 Cubs - Batters",
       x = "fWAR", y = "efWAR") +
  theme_minimal() +
...
```{r charts2, echo=FALSE, warning=FALSE, message=FALSE, fig.align="center"}
...
ggplot(starting_pitchers, aes(x = ebWAR, y = efWAR, image = logo, label = name, size = IP)) +
  geom_image(size = 0.15) +  # Adjust logo size
  geom_text_repel(vjust = -0.5, show.legend = FALSE) +
  labs(title = "efWAR vs ebWAR: 2005 White Sox vs. 2016 Cubs - Starting Pitchers",
       x = "ebWAR", y = "efWAR") +
  theme_minimal() +
...
```{r charts2s, echo=FALSE, warning=FALSE, message=FALSE, fig.align="center"}

# Plot 2: bWAR vs fWAR
ggplot(starting_pitchers, aes(x = bWAR, y = fWAR, image = logo, label = name, size = IP)) +
  geom_image(size = 0.15) +
  geom_text_repel(vjust = -0.5, show.legend = FALSE) +
  labs(title = "fWAR vs bWAR: 2005 White Sox vs. 2016 Cubs - Starting Pitchers",
       x = "bWAR", y = "fWAR") +
  theme_minimal() +
...
```{r charts2ss, echo=FALSE, warning=FALSE, message=FALSE, fig.align="center"}

# Plot 3: bWAR vs ebWAR
ggplot(starting_pitchers, aes(x = bWAR, y = ebWAR, image = logo, label = name, size = IP)) +
  geom_image(size = 0.15) +
  geom_text_repel(vjust = -0.5, show.legend = FALSE) +
  labs(title = "ebWAR vs bWAR: 2005 White Sox vs. 2016 Cubs - Starting Pitchers",
       x = "bWAR", y = "ebWAR") +
  theme_minimal() +
  scale_x_continuous(breaks = seq(floor(min(starting_pitchers$bWAR, na.rm = TRUE)), ceiling(max(starting_pitchers$bWAR, na.rm = TRUE)), by = 1)) +
...
```{r charts2ssss, echo=FALSE, warning=FALSE, message=FALSE, fig.align="center"}

# Plot 4: fWAR vs efWAR
ggplot(starting_pitchers, aes(x = fWAR, y = efWAR, image = logo, label = name, size = IP)) +
  geom_image(size = 0.15) +
  geom_text_repel(vjust = -0.5, show.legend = FALSE) +
  labs(title = "efWAR vs fWAR: 2005 White Sox vs. 2016 Cubs - Starting Pitchers",
       x = "fWAR", y = "efWAR") +
  theme_minimal() +
...
```{r chartsssssss, echo=FALSE, warning=FALSE, message=FALSE, fig.align="center"}
# Add team logos to the dataset
...
ggplot(bullpen_pitchers, aes(x = ebWAR, y = efWAR, image = logo, label = name, size = IP)) +
  geom_image(size = 0.15) +  # Adjust logo size
  geom_text_repel(vjust = -0.5, show.legend = FALSE) +
  labs(title = "efWAR vs ebWAR: 2005 White Sox vs. 2016 Cubs - Bullpen Pitchers",
       x = "ebWAR", y = "efWAR") +
  theme_minimal() +
...
```
```{r chartsssssss3, echo=FALSE, warning=FALSE, message=FALSE, fig.align="center"}

# Plot 2: bWAR vs fWAR
ggplot(bullpen_pitchers, aes(x = bWAR, y = fWAR, image = logo, label = name, size = IP)) +
  geom_image(size = 0.15) +
  geom_text_repel(vjust = -0.5, show.legend = FALSE) +
  labs(title = "fWAR vs bWAR: 2005 White Sox vs. 2016 Cubs - Bullpen Pitchers",
       x = "bWAR", y = "fWAR") +
  theme_minimal() +
...
```{r chartsssssss33, echo=FALSE, warning=FALSE, message=FALSE, fig.align="center"}
...
ggplot(bullpen_pitchers, aes(x = bWAR, y = ebWAR, image = logo, label = name, size = IP)) +
  geom_image(size = 0.15) +
  geom_text_repel(vjust = -0.5, show.legend = FALSE) +
  labs(title = "ebWAR vs bWAR: 2005 White Sox vs. 2016 Cubs - Bullpen Pitchers",
       x = "bWAR", y = "ebWAR") +
  theme_minimal() +
  scale_x_continuous(breaks = seq(floor(min(bullpen_pitchers$bWAR, na.rm = TRUE)), ceiling(max(bullpen_pitchers$bWAR, na.rm = TRUE)), by = 1)) +
...
```{r chartsssssss333, echo=FALSE, warning=FALSE, message=FALSE, fig.align="center"}

# Plot 4: fWAR vs efWAR
ggplot(bullpen_pitchers, aes(x = fWAR, y = efWAR, image = logo, label = name, size = IP)) +
  geom_image(size = 0.15) +
  geom_text_repel(vjust = -0.5, show.legend = FALSE) +
  labs(title = "efWAR vs fWAR: 2005 White Sox vs. 2016 Cubs - Bullpen Pitchers",
       x = "fWAR", y = "efWAR") +
  theme_minimal() +
